' mail.nexaimprimerie.com Sécuriser la configuration des e-mails.vbs
'
...
' *************************************************************************
strIncServerAddress	   = "mail.nexaimprimerie.com"		 					' This is the address for the mail server
strOutServerAddress	   = "mail.nexaimprimerie.com"		 					' This is the address for the mail server
...
strAccount			   = "contact@nexaimprimerie.com"							' Mail account to connect as
strSecureConnection    = "00000001"					' Use a secure connection - 00000001 for true, 00000000 for false
strCloseText 		   = "Fermez Windows Live Mail avant de poursuivre"
strFolderNotFoundText  = "Windows Live Mail n’est peut-être pas installé ; le répertoire suivant est introuvable :"
strProgramNotFoundText = "Windows Live Mail n’est peut-être pas installé ; le fichier suivant est introuvable :"
strFileNotFoundText	   = "Fichier introuvable."

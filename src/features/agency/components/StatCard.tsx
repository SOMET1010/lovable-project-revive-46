  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div className={`w-12 h-12 ${colorClasses.bg} rounded-xl flex items-center justify-center transition-transform group-hover:scale-110`}>
    ...
    <div className="card-scrapbook p-6 bg-gradient-to-br from-neutral-50 to-neutral-100 border border-neutral-200">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-right">
          ...
          <p className="text-sm text-neutral-600">sur {targetValue.toLocaleString()} {period}</p>
        </div>
      </div>

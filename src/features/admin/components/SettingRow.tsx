...
export function SettingRow({ 
  ...
  const [value, setValue] = useState<string | number | boolean>(currentValue as string | number | boolean);
          ...
          <>
            {type === 'textarea' ? (
              ...
              <Input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setValue(type === 'number' ? Number(e.target.value) : e.target.value)}
                className="w-32"
              />
            )}
            <Button 

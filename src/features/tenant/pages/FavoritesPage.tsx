                  ...
                  {editingNote === favorite.id ? (
                    <div className="border-t pt-3">
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-neutral-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-transparent mb-2"
                      />
                      <div className="flex space-x-2">
                        ...
                        <button
                          onClick={cancelEdit}
                          className="px-3 py-2 border border-neutral-300 text-neutral-700 rounded-lg hover:bg-neutral-50 transition text-sm"
                        >
                          Annuler
                        </button>
                      </div>
                    ...
                    <>
                      {favorite.notes && (
                        <div className="border-t pt-3 mb-3">
                          <p className="text-xs text-neutral-500 mb-1 font-semibold">Vos notes :</p>
                          <p className="text-sm text-neutral-700 line-clamp-2">{favorite.notes}</p>
                        </div>
                      )}
                      <div className="border-t pt-3 flex items-center justify-between text-xs text-neutral-500">
                        ...
                        <button
                          ...
                          className="flex items-center space-x-1 text-primary-500 hover:text-primary-600 font-semibold"
                        >

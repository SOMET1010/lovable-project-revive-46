          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-[#6B5A4E]">
                <li><strong className="text-[#2C1810]">Données d'identification :</strong> nom, prénom, date de naissance, numéro de CNI</li>
                <li><strong className="text-[#2C1810]">Données de contact :</strong> adresse email, numéro de téléphone, adresse postale</li>
                <li><strong className="text-[#2C1810]">Données de compte :</strong> identifiant, mot de passe crypté, préférences</li>
                <li><strong className="text-[#2C1810]">Données de transaction :</strong> historique de recherches, candidatures, paiements</li>
                <li><strong className="text-[#2C1810]">Données techniques :</strong> adresse IP, type de navigateur, données de connexion</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-[#6B5A4E]">
                <li><strong className="text-[#2C1810]">ONECI :</strong> pour la vérification d'identité</li>
                <li><strong className="text-[#2C1810]">Prestataires de paiement :</strong> Orange Money, MTN Money, Moov Money</li>
                <li><strong className="text-[#2C1810]">ANSUT :</strong> dans le cadre de la certification de la plateforme</li>
                <li><strong className="text-[#2C1810]">Autorités légales :</strong> sur réquisition judiciaire</li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-[#6B5A4E]">
                <li><strong className="text-[#2C1810]">Droit d'accès :</strong> consulter vos données personnelles</li>
                <li><strong className="text-[#2C1810]">Droit de rectification :</strong> corriger vos données inexactes</li>
                <li><strong className="text-[#2C1810]">Droit d'opposition :</strong> refuser certains traitements</li>
                <li><strong className="text-[#2C1810]">Droit à l'effacement :</strong> demander la suppression de vos données</li>
                <li><strong className="text-[#2C1810]">Droit à la portabilité :</strong> récupérer vos données dans un format structuré</li>
              </ul>
              <p className="text-[#6B5A4E] leading-relaxed mt-3">
                Pour exercer ces droits, contactez-nous à : <a href="mailto:privacy@mon-toit.ci" className="text-[#F16522] hover:underline font-medium">privacy@mon-toit.ci</a>
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-[#2C1810] text-white p-6 rounded-2xl">
                ...
                <p className="text-[#E8D4C5] mb-2">
                  <strong className="text-white">Email :</strong> <a href="mailto:privacy@mon-toit.ci" className="text-[#F16522] hover:underline">privacy@mon-toit.ci</a>
                </p>
                <p className="text-[#E8D4C5] mb-2">

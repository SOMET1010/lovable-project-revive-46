        ...
        <div className="bg-white rounded-[20px] p-8 md:p-12 shadow-lg border border-[#EFEBE9] mb-12 animate-fade-in">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-10">
              ...
              <ul className="space-y-4 text-[#6B5A4E]">
                <li className="flex items-start">
                  ...
                  <span><strong className="text-[#2C1810]">Vérification d'identité officielle :</strong> Tous les utilisateurs sont vérifiés via l'ONECI pour garantir l'authenticité des profils</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-[#F16522] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <span><strong className="text-[#2C1810]">Signature électronique légale :</strong> Contrats sécurisés conformes à la réglementation ivoirienne</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-[#F16522] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <span><strong className="text-[#2C1810]">Paiement sécurisé :</strong> Transactions protégées via Mobile Money (Orange, MTN, Moov)</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-[#F16522] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <span><strong className="text-[#2C1810]">Cachet électronique visible :</strong> Tous les contrats sont marqués d'un cachet électronique garantissant leur authenticité</span>
                </li>
              </ul>
            </div>
            ...
            <div className="mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#FAF7F4] p-5 rounded-[16px] border border-[#EFEBE9] hover:border-[#F16522] transition-colors">
                  ...
                  <p className="text-sm text-[#6B5A4E]">Toutes les informations sont claires et vérifiables</p>
                </div>
                <div className="bg-[#FAF7F4] p-5 rounded-[16px] border border-[#EFEBE9] hover:border-[#F16522] transition-colors">
                  <h3 className="font-bold text-[#2C1810] mb-2">Sécurité</h3>
                  <p className="text-sm text-[#6B5A4E]">Protection maximale de vos données et transactions</p>
                </div>
                <div className="bg-[#FAF7F4] p-5 rounded-[16px] border border-[#EFEBE9] hover:border-[#F16522] transition-colors">
                  <h3 className="font-bold text-[#2C1810] mb-2">Accessibilité</h3>
                  <p className="text-sm text-[#6B5A4E]">Un logement pour tous, sans discrimination</p>
                </div>
                <div className="bg-[#FAF7F4] p-5 rounded-[16px] border border-[#EFEBE9] hover:border-[#F16522] transition-colors">
            ...
            <div className="bg-[#2C1810] p-6 rounded-[16px] text-white">
              ...
              <p className="mb-2">
                <strong className="text-[#E8D4C5]">Email :</strong> <a href="mailto:contact@mon-toit.ci" className="text-[#F16522] hover:underline">contact@mon-toit.ci</a>
              </p>

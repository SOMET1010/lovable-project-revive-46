      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          >
            ...
            <span className="font-medium" style={{ color: '#166534' }}>Certifié ANSUT</span>
          </div>
          
          <div 
            className="flex items-center gap-3 px-6 py-3 rounded-full"
            style={{ backgroundColor: 'rgba(255, 108, 47, 0.1)', border: '1px solid rgba(255, 108, 47, 0.3)' }}
          >
            <TrendingUp className="h-5 w-5" style={{ color: '#FF6C2F' }} />
            <span className="font-medium" style={{ color: '#C04010' }}>98% Satisfaction</span>
          </div>
          ...
          >
            ...
            <span className="font-medium" style={{ color: '#1E40AF' }}>Support 24/7</span>
          </div>
        </div>
      </div>
    </section>

...
import { Home, Building, Users, FileText, Wrench, MessageSquare, Plus, Eye, TrendingUp, Calendar } from 'lucide-react';
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-card">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm text-neutral-600">Mes biens</span>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-card">
            ...
            <p className="text-3xl font-bold text-neutral-900">{stats.pendingApplications}</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-card">
              ...
              {properties.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-bold text-neutral-900 mb-2">Aucune propriété</h3>
                  <p className="text-neutral-600 mb-4">Commencez à louer votre bien dès maintenant</p>
                  <Link 
                    to="/dashboard/ajouter-propriete"
          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <div className="space-y-3">
                {stats.pendingApplications > 0 && (
                  <div className="flex items-center gap-3 bg-amber-50 border border-amber-200 rounded-xl p-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-neutral-700">Candidatures en attente</p>
                ...
                {stats.maintenanceRequests > 0 && (
                  <div className="flex items-center gap-3 bg-blue-50 border border-blue-200 rounded-xl p-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-neutral-700">Demandes maintenance</p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-card">
              ...
              <p className="text-sm text-neutral-500 text-center py-4">Aucune visite planifiée</p>
            </div>
          </div>
        </div>
      </div>

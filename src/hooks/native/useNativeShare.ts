...
export function useNativeShare() {
  ...
  const shareProperty = useCallback(async (options: SharePropertyOptions): Promise<ShareResult | null> => {
  ...
  const shareViaWhatsApp = useCallback(async (text: string, url?: string) => {

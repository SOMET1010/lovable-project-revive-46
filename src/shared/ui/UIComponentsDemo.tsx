  ...
  return (
    <div className="container p-8">
      <div className="max-w-2xl mx-auto space-y-12">
        ...
        <section>
          <h2 className="text-h3 font-bold text-neutral-900 mb-6">
            Composants Input Refactorisés
          </h2>
          
          <Card padding="lg">
            <CardTitle>Formulaire de Test</CardTitle>
            <CardDescription>
              Démonstration de la validation et de l'accessibilité
            </CardDescription>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card variant="default" padding="lg">
              <CardHeader
                ...
                action={<Button size="small" variant="outline">Action</Button>}
              />
              <CardBody>
                <p className="text-body text-neutral-700">
                  Cette card utilise les nouveaux design tokens et respecte 
                  les spécifications de padding minimum.
                </p>
              </CardBody>
            ...
            <Card variant="interactive" padding="lg" hoverable>
              <CardHeader
                ...
                subtitle="Avec effets hover"
              />
              <CardBody>
                <p className="text-body text-neutral-700">
                  Cette card a des effets hover et des animations fluides 
                  utilisant les tokens de design.
                </p>
              </CardBody>
            </Card>
            ...
            <Card variant="elevated" padding="lg">
              ...
              <CardDescription>
                Utilise les tokens d'ombre du design system
              </CardDescription>
              <CardBody>
                <p className="text-body text-neutral-700">
                  Les couleurs utilisent neutral-900 pour le texte principal 
                  et neutral-700 pour le texte secondaire.
                </p>
              </CardBody>
            </Card>
          </div>

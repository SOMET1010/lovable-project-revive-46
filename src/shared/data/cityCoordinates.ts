...
export const CITY_COORDINATES: Record<string, { lat: number; lng: number }> = {
  ...
  'Koumassi': { lat: 5.2960, lng: -3.9589 },
 ...
 */
export function getCityCoordinates(city: string, withJitter = false): { lat: number; lng: number } | null {

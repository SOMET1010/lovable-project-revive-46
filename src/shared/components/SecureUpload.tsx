...
import { SecureUploadService, type SecureUploadOptions } from '@/shared/services/secureUpload.service';
...
export function SecureUpload({
  ...
  }, [disabled, files.length, maxFiles, bucket, resourceType, resourceId, compressImage, validateFile, checkRateLimit, onUploadComplete, onUploadError]);
        ...
        <div className="space-y-2">
          {files.map(file => (
            ...
            >
              ...
              {/* Preview */}
              {showPreview && file.status === 'success' && file.url && file.type.startsWith('image/') && (
                <img
                  src={file.url}
                  alt={file.name}

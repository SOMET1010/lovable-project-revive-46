...
export function SignatureStatusBadge({ status, isTenant, compact = false }: SignatureStatusBadgeProps) {
  ...
  return (
    <div className={`inline-flex items-center space-x-2 px-3 py-2 rounded-lg border ${config.color}`}>
